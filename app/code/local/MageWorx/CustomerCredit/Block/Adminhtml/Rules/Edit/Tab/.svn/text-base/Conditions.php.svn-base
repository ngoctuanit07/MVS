...
class MageWorx_CustomerCredit_Block_Adminhtml_Rules_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $renderer = Mage::getBlockSingleton('adminhtml/widget_form_renderer_fieldset')
            ...
            ->setNewChildUrl($this->getUrl('*/adminhtml_rules/newConditionHtml/form/rule_conditions_fieldset'));
        ...
        $fieldset->addField('conditions', 'text', array(
            ...
            'required' => true,
        ))->setRule($model)->setRenderer(Mage::getBlockSingleton('customercredit/rules_conditions'));
