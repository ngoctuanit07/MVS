...
class MageWorx_CustomerCredit_Block_Adminhtml_Rules_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_rules_edit_tab_main')->toHtml(),
            'active'    => true
        ));

        $this->addTab('conditions_section', array(
            'label'     => Mage::helper('salesrule')->__('Conditions'),
            'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_rules_edit_tab_conditions')->toHtml(),
...
//            'class' => 'ajax',
        ...
        $this->addTab('actions_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_rules_edit_tab_actions')->toHtml(),
        ));
