    ...
    protected function _beforeToHtml()
    {
        ...
        if ($codeModel->getIsNew())
        {
            $this->addTab('settings_section', array(
                ...
                'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_code_edit_tab_settings')->toHtml(),
                'active'    => true,
            ));
        }
        $this->addTab('details_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_code_edit_tab_details')->toHtml(),
        ...
        if (!$codeModel->getIsNew())
        {
            $this->addTab('log_section', array(
                ...
                'content'   => $this->getLayout()->createBlock('customercredit/adminhtml_code_edit_tab_log')->toHtml(),
            ));
        }
