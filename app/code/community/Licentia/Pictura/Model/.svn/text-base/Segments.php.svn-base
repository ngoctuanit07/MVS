 ...
 */
class Licentia_Pictura_Model_Segments extends Mage_Core_Model_Abstract {

    const MYSQL_DATE = 'yyyy-MM-dd';

    protected function _construct() {
        $this->_init('pictura/segments');
    }

    public function getSelectedSegmentsIds($bannerId) {
